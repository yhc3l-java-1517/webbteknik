...
},{"../constants/action-types":18}],17:[function(require,module,exports){
'use strict';
...
_store2.default.dispatch(actions.addPet({ id: 15, animal: 'fish' }));

window.store = _store2.default;

},{"./actions":16,"./store":23}],18:[function(require,module,exports){
'use strict';
...
},{"../constants/action-types":18}],20:[function(require,module,exports){
'use strict';
...
},{"./basket":19,"./pets":21,"./user":22,"redux":11}],21:[function(require,module,exports){
'use strict';
...
},{"../constants/action-types":18}],22:[function(require,module,exports){
'use strict';
...
var reducer = function reducer() {
  var userState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { id: 1, name: 'Tom' };
  var action = arguments[1];
...
},{"../constants/action-types":18}],23:[function(require,module,exports){
'use strict';
